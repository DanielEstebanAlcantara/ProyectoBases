...
--1
EXEC SERVICIO.REGISTRAR_SERVICIO
   82 ,1, 'R', 7, '2023-01-02', '2023-01-02 10:00:00', 'Cambio  de aceite', 5000, 'P',  '2023-01-02 10:30:00', '2023-01-03 9:00:00';

--2
EXEC SERVICIO.REGISTRAR_SERVICIO
    82, 1, 'C', 8, '2023-02-05', '2023-02-05 10:00:00', 'Revision de aceite', 3000, 'P',  '2023-02-05 10:00:00', '2023-02-07 10:00:00';

--3
EXEC SERVICIO.REGISTRAR_SERVICIO
    82, 1, 'R', 9, '2023-03-05', '2023-03-05 10:00:00', 'Cambio de Llantas', 8000, 'P',  '2023-04-10 12:00:00', '2023-04-11 9:00:00';
--4
EXEC SERVICIO.REGISTRAR_SERVICIO
    82, 1, 'R', 14, '2023-03-16', '2023-03-16 10:00:00', 'Cambio filtro de gasonalina', 4000, 'P',  '2023-03-16 10:00:00', '2023-03-16 16:00:00';
--5
EXEC SERVICIO.REGISTRAR_SERVICIO
    82, 1, 'C', 13, '2023-04-02', '2023-04-02 10:00:00', 'Revision de filtros de aire', 200, 'P',  '2023-04-02 10:30:00', '2023-04-02 13:00:00';
--6
EXEC SERVICIO.REGISTRAR_SERVICIO
    82, 1, 'R', 7, '2023-06-09', '2023-06-09 10:00:00', 'Cambio  de aceite',5000 , 'P',  '2023-06-09 10:45:00', '2023-06-09 16:00:00';
--7
EXEC SERVICIO.REGISTRAR_SERVICIO
    29, 3, 'C', 17, '2023-06-09', '2023-06-09 10:20:00', 'Revision de bateria', 500, 'P',  '2023-06-09 11:00:00', '2023-06-09 13:00:00';
--8
EXEC SERVICIO.REGISTRAR_SERVICIO
    29, 3, 'C', 15, '2023-06-10', '2023-06-10 10:00:00', 'Cambio  de aceite', 5000, 'P',  '2023-06-10 15:00:00', '2023-06-11 10:00:00';

--9
EXEC SERVICIO.REGISTRAR_SERVICIO
    35, 4, 'R', 7, '2023-06-11', '2023-06-11 10:00:00', 'Cambio  de aceite', 5000, 'P',  '2023-06-11 10:50:00', '2023-06-11 12:30:00';
--10
EXEC SERVICIO.REGISTRAR_SERVICIO
    37, 5, 'R', 21, '2023-06-14', '2023-06-14 10:00:00', 'Cambios de bujias', 6000, 'P',  '2023-06-14 11:00:00', '2023-06-15 10:00:00';

--11
EXEC SERVICIO.REGISTRAR_SERVICIO
    44, 6, 'C', 15, '2023-06-14', '2023-06-14 10:30:00', 'Revision de neumaticos', 200, 'P',  '2023-06-14 10:30:00', '2023-06-14 12:00:00';
--12
EXEC SERVICIO.REGISTRAR_SERVICIO
    47, 7, 'C', 17, '2023-06-15', '2023-06-15 10:00:00', 'Revision de bateria', 100, 'P',  '2023-06-15 11:00:00', '2023-06-15 12:00:00';

--13
EXEC SERVICIO.REGISTRAR_SERVICIO
    66, 14, 'R', 18, '2023-06-16', '2023-06-16 10:00:00', 'Reparacion de frenos', 5000, 'P',  '2023-06-16 10:45:00', '2023-06-16 12:00:00';
--14

EXEC SERVICIO.REGISTRAR_SERVICIO
    68, 15, 'R', 21, '2023-06-18', '2023-06-18 10:00:00', 'Cambio de Llantas', 2000, 'P',  '2023-06-18 11:00:00', '2023-06-17 10:00:00';
--15
EXEC SERVICIO.REGISTRAR_SERVICIO
    74, 19, 'C', 8, '2023-07-02', '2023-07-02 10:00:00', 'Revision de frenos', 5000, 'P',  '2023-07-02 13:00:00', '2023-07-08 9:00:00';
